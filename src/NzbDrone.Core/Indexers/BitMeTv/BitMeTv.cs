...
namespace NzbDrone.Core.Indexers.BitMeTv
{
    public class BitMeTv : HttpIndexerBase<BitMeTvSettings>
    {
        ...
        public BitMeTv(IIndexerStatusService indexerStatusService, IHttpClient httpClient, IConfigService configService, IParsingService parsingService, Logger logger)
